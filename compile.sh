...
g++ -Wno-unused-function maketree.cpp -o maketree -std=c++11 process_output.o config.o -Wall -pthread -DDEBUG
g++ -Wno-unused-function autocompile_test.cpp -o autocompile_test -std=c++11 process_output.o config.o -Wall -pthread -DDEBUG
g++ -Wno-unused-function maketree_test.cpp -o maketree_test -std=c++11 process_output.o config.o -Wall -pthread -DDEBUG
